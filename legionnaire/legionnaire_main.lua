...
BotEcho(object:GetName()..' loading legionnaire_main...')
...
behaviorLib.StartingItems  = {"Item_LoggersHatchet", "Item_IronBuckler", "Item_HealthPotion"}
behaviorLib.LaneItems  = {"Item_IronBuckler", "Item_Lifetube", "Item_Marchers", "Item_Shield2", "Item_BloodChalice"}
behaviorLib.MidItems  = {"Item_PortalKey", "Item_SolsBulwark", "Item_Steamboots", "Item_Excruciator"}
